...
| **16** | Unified Tree (U2) — ✅ 16a (07/2026), 16b còn lại | Tree hợp nhất bên phải (bones lồng slots/attachments + sections Constraints/Skins/Events/Animations/Images), cột visibility, icon màu, search/filter, rename inline, context menu; properties dock đáy tree theo selection; thay Hierarchy+Properties            |

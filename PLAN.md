...
| Rigging     | Meshes (tạo lưới, chỉnh vertex, edit UV)                      | ✅         | Phase 8: nút Edit — kéo vertex trong viewport (setup sửa mesh, animate auto-key deform). Phase 19: thêm/xóa/weld vertex + Delaunay retriangulate, Weights window |
...
>   Chưa làm: kéo vertex mesh weighted (chỉnh qua weights), UV editor. Thêm/xóa vertex
>   - retriangulate: ✅ Phase 19 (delaunator, `mesh-edit.ts`, Weights window).
...
| **16** | Unified Tree (U2) — ✅ (07/2026, cả 16a+16b)                                           | Tree hợp nhất bên phải (bones lồng slots/attachments + sections Constraints/Skins/Events/Animations/Images), cột visibility, icon màu, search/filter, rename inline, context menu; properties dock đáy tree theo selection; thay Hierarchy+Properties            |
| **17** | Animate dock (U3) — ✅ (07/2026)                                                       | Tab Graph/Dopesheet + toolbar (Sync, copy/paste key, filter, lock, Shift/Offset/Adjust, Current/Loop Start/End) + transport; key tick màu theo loại timeline, trắng khi trùng frame, đường nối theo interpolation, hàng tổng diamond                             |
| **18** | Preview + Playback + Ghosting — ✅ (07/2026, Playback gộp vào transport P17 + Preview) | Bộ trộn track trong core (speed/mix/repeat/alpha/hold-previous/additive, 4 track); view Preview, Playback, Ghosting                                                                                                                                              |
